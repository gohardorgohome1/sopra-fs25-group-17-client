...
const ExoplanetProfile: React.FC = () => {
  ...
  return (
    ...
    <div style={{width: 635, height: 117, left: 615, top: 574, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 24, fontFamily: 'Jura', fontWeight: '700', wordWrap: 'break-word'}}>Time</div>
    <div style={{width: 696.24, height: 117, left: 477, top: 769.24, position: 'absolute', transform: 'rotate(-90deg)', transformOrigin: 'top left', textAlign: 'center', color: 'white', fontSize: 24, fontFamily: 'Jura', fontWeight: '700', wordWrap: 'break-word'}}>Brightness</div>
    <div style={{width: 368, height: 0, left: 516.99, top: 206, position: 'absolute', transform: 'rotate(90deg)', transformOrigin: 'top left', outline: '7px white solid', outlineOffset: '-3.50px'}}></div>
    <div style={{width: 852, height: 0, left: 1369, top: 567, position: 'absolute', transform: 'rotate(180deg)', transformOrigin: 'top left', outline: '7px white solid', outlineOffset: '-3.50px'}}></div>
    ...
    <div style={{width: 667, height: 113, left: 190, top: 713, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 32, fontFamily: 'Jura', fontWeight: '700', wordWrap: 'break-word'}}>0.05%</div>
    <div style={{width: 667, height: 113, left: 31, top: 833, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 32, fontFamily: 'Jura', fontWeight: '700', wordWrap: 'break-word'}}>1.12 R⊕</div>
    <div style={{width: 667, height: 113, left: 6, top: 962, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 32, fontFamily: 'Jura', fontWeight: '700', wordWrap: 'break-word'}}>1.27 M⊕</div>
    <div style={{width: 667, height: 113, left: 652, top: 839, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 32, fontFamily: 'Jura', fontWeight: '700', wordWrap: 'break-word'}}>9.94m/s2</div>
    <div style={{width: 667, height: 113, left: 652, top: 967, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 32, fontFamily: 'Jura', fontWeight: '700', wordWrap: 'break-word'}}>11.19km/s</div>
    <div style={{width: 667, height: 113, left: 1099, top: 715, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 32, fontFamily: 'Jura', fontWeight: '700', wordWrap: 'break-word'}}>35.26 days</div>
    <div style={{width: 667, height: 113, left: 546, top: 711, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 32, fontFamily: 'Jura', fontWeight: '700', wordWrap: 'break-word'}}>4.96g/cm3</div>
    <div style={{width: 667, height: 113, left: 1250, top: 836, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 32, fontFamily: 'Jura', fontWeight: '700', wordWrap: 'break-word'}}>310.45K</div>
    <div style={{width: 667, height: 113, left: 1173, top: 967, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 32, fontFamily: 'Jura', fontWeight: '700', wordWrap: 'break-word'}}>88%</div>
    ...
    <div style={{width: 1001, height: 112, left: -124, top: 35, position: 'absolute', textAlign: 'center', color: '#FFD9D9', fontSize: 96, fontFamily: 'Koulen', fontWeight: '400', wordWrap: 'break-word'}}>Kepler-438b</div>
    <div style={{width: 1001, height: 78, left: 994, top: 59, position: 'absolute', textAlign: 'center', color: '#FFD9D9', fontSize: 64, fontFamily: 'Koulen', fontWeight: '400', wordWrap: 'break-word'}}>Kepler-438</div>
    <div style={{width: 853.50, height: 183.50, left: 524, top: 349, position: 'absolute', outline: '6px white solid', outlineOffset: '-3px'}} />
